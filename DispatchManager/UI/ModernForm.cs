...
public class ModernForm : Form
{
    ...
    // Public Properties
    // ----------------------
    public bool ShowMenuStrip { get; set; } = true;
    ...
    public ModernForm()
    {
        // Enable smooth painting & redraw on resize/drag
        ...
        menuStrip1 = new MenuStrip
        {
            ...
            Renderer = new ToolStripProfessionalRenderer(new NoBorderColorTable(this))
        };
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        if (!ShowMenuStrip && menuStrip1 != null)
    ...
    {
        // Prevent default background painting and clear it ourselves
...
//    private class NoBorderColorTable : ProfessionalColorTable
//    {
//        public override Color ToolStripBorder => Color.CornflowerBlue;
//        public override Color MenuBorder => Color.CornflowerBlue;
